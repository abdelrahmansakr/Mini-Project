				...
				<table width="100%" >
		  		...
		  		<hr>
			  		<table style="width:100%; font-size: 16px" cellpadding="5" class="font">
						<tr> <form action="edit_profile_check.php" method="POST" enctype="multipart/form-data"></tr>
							...
							<tr><td><b class="orangeFont">E-Mail: </b><input type="text" name="email" value=<?php echo $email; ?>></td></tr>
							<tr><td><b class="orangeFont">Confirm E-Mail: </b><input type="text" name="c_email" value=<?php echo $email; ?>></td></tr>
							<tr><td><b class="orangeFont">Password: </b><a href="change_password.php">Change Password</a></td></tr>
							<tr><td><b class="orangeFont">First Name: </b><input type="text" name="firstname" value=<?php echo $firstname; ?>></td></tr>
							<tr><td><b class="orangeFont">Last Name: </b><input type="text" name="lastname" value=<?php echo $lastname; ?>></td></tr>
							<tr><td><b class="orangeFont">Change Avatar: </b><input type="file" name="uploaded_image" class="btn btn-default"/></td></tr>
							<tr><td>
